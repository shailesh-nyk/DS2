...
// //Using The Sieve of Eratosthenes is one of the most efficient ways to find all prime numbers up to n. 
...
var countPrimes = function(n) {
    let isPrime = Array(n).fill(true);   //create n size array with all values set to true
    isPrime[0] = false;
     for(let i = 2 ; i * i < n ; i++ ) {
